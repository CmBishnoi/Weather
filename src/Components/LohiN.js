...
import abc from "../Assets/neww.gif";
...
const LohiN = () => {
  ...
  const handleLogin = () => {
    ...
    const validEmail = 'Weather123@gmail.com';
    const validPassword = 'Weather123';

    if (email === validEmail && password === validPassword) {
      // If both fields are valid and match the correct credentials, navigate to the home page
      setError('');
       navigate('/Login');
  ...
  return (
    ...
    <div class="bg-[#dfa674] rounded-2xl flex max-w-3xl p-5 items-center">
        <div class="md:w-1/2 px-8">
            ...
            <p class="text-sm mt-4 text-[#002D74]">Email : Weather123@gmail.com <br></br> Password: Weather123 </p>
          

            <form action="" class="flex flex-col gap-4" >
           
                <input class="p-2 mt-8 rounded-xl border" type="email" value={email} onChange={(e) =>setEmail(e.target.value)} placeholder="Email"/>
                
                <div class="relative">
                    <input class="p-2 rounded-xl border w-full" type="password" value={password} id="password" onChange={(e)=> setPassword(e.target.value)} placeholder="Password" />
                ...
                <button class="bg-[#002D74] text-white py-2 rounded-xl hover:scale-105 duration-300 hover:bg-[#206ab1] font-medium" type="submit" onClick={handleLogin}>Login</button>
        ...
        <div class="md:block hidden w-1/2">
            <img class="rounded-2xl max-h-[1600px]" src={abc} alt="login form image"/>
        </div>
        {/* <div class="m-0 xl:m-0 w-full bg-contain bg-center bg-no-repeat"
